...
| 9 | Checkout price override — trusts client-supplied `subtotalPence` | `FAULT_PRICE_OVERRIDE` (**demo-store-api**) | `POST /api/checkout-price` | `app/api/checkout-price/route.ts:6` |
